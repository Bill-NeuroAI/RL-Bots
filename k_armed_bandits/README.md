...
## Overview
Implemented stationary stochastic K-bandits using Jax library. 

Explored  exploration, exploitation dynamics, and how fast reinforcement learning agents learn
...
This project is over. My next project will be a tabular-q gridworld using only jax, once again. Will look to expand library usage once I reach DQN. 
